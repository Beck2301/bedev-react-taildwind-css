    ...
    return (
        <>
            <div class="text-center mt-20 c-first dark:bg-dark">
                <div class="md:flex  ">
                    <div class="flex-1 ">
                        <img src="https://i.ibb.co/4PJDRTC/me-home.png" alt="" class="w-72 mb-6 md:w-96 rounded-full border-yellow-400 border-4 m-auto wow animate__animated animate__fadeInLeft" />
                    </div>
