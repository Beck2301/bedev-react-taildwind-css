    ...
    return (
        <>
            <div class="text-center mt-20 c-first dark:bg-dark">
                <div class="md:flex  ">
                    <div class="flex-1 ">
                        <img src="https://i.ibb.co/4PJDRTC/me-home.png" alt="" class="w-72 mb-6 md:w-80 2xl:w-96 rounded-full border-yellow-400 border-4 m-auto wow animate__animated animate__fadeInLeft" />
                    </div>
                    <div class="pl-4 pr-4 md:flex-1 m-auto  md:text-justify  dark:text-white">
                        <h1 class="text-5xl  md:text-6xl 2xl:text-8xl mb-5" >HI <img src="https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/160/apple/285/waving-hand_1f44b.png" alt="" className="w-11 text-center 2xl:w-20 md:w-16 inline wow animate__animated animate__shakeX " /> I am </h1>
                        <h1 class="text-6xl  md:text-6xl 2xl:text-8xl  mb-5 ">Bryan Escobar </h1>
