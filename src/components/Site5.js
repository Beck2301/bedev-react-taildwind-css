            ...
            <div className="bg-black " >
                <div className="flex items-center md:flex-row justify-center flex-col container m-auto   p-10 rounded-2xl" >
                    ...
                    <div className="flex-1">
                        <img src="https://i.ibb.co/mRGHTs5/11.png" alt="" className="m-auto wow animate__animated animate__fadeInRight  md:w-5/6" />
                    </div>
                </div>

            </div>
            <div className="md:py-28 flex items-center justify-center m-auto md:flex-row flex-col">
                <img src="https://i.ibb.co/gdv4HYh/12.png" alt="" className=" m-auto wow animate__animated animate__fadeInUp md:w-2/6" />
                <img src="https://i.ibb.co/SvxPY2k/10.png" alt="" className="m-auto wow animate__animated animate__fadeInUp   md:w-2/6" />
            </div>
            ...
            <div className="text-white text-center p-10 ">
                ...
                <a href="https://beck2301.github.io/on-the-rocks/" target="_blank" className="">
                    <button class="transition duration-500 ease-in-out  hover:bg-yellow-500 transform hover:-translate-y-1 hover:scale-110 p-12 shadow-2xl md:text-5xl text-lg rounded-2xl dark:text-white text-black">
                        Visit On The Rocks <i class="fas fa-link dark:text-white"></i>
                    </button>
                </a>
            </div>
            <Footer />
