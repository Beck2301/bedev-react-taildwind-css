            ...
            <div className="bg-black " >
                <div className="flex items-center md:flex-row justify-center flex-col container m-auto   p-10 rounded-2xl" >
                    <div className="flex-1  text-center md:text-justify text-white  dark:text-white md:text-2xl">
                        ...
                        <br/>
                        <h1 className="wow animate__animated animate__fadeInLeft mb-5 md:mb-0 ">This project was created by a good friend and I in 2020 when there was not much information about the cases in El Salvador and Central America.</h1>
                    </div>
                    <div className="flex-1">
                        <img src="https://i.ibb.co/Rg484m9/1.png" alt="" className="m-auto wow animate__animated animate__fadeInRight " />
                    </div>
                </div>
