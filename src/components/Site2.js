            ...
            <div className="bg-black " >
                <div className="flex items-center md:flex-row justify-center flex-col container m-auto   p-10 rounded-2xl" >
                    ...
                    <div className="flex-1">
                        {/* <img src="https://i.ibb.co/RbSM7MP/1.png" alt="" className="m-auto wow animate__animated animate__fadeInRight  md: " /> */}
                        <img src="https://i.ibb.co/ccPMwSh/2.png" alt="" className=" m-auto wow animate__animated animate__fadeInUp  md:w-5/6 " />
                    </div>
                </div>
            </div>
           ...
           {/* eslint-disable-next-line */}
                <a href="https://beck2301.github.io/covid19/" target="_blank" className="flex-1">
                    ...
                    <button class="transition duration-500 ease-in-out  hover:bg-yellow-500 transform hover:-translate-y-1 hover:scale-110 p-9 shadow-lg md:text-5xl text-lg rounded-2xl dark:text-white text-black">
                        Covid-19 El Salvador <i class="fas fa-link dark:text-white"></i>
                    </button>
                </a>
