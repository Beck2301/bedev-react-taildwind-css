            ...
            <div class="text-center mt-20 c-first dark:bg-dark">
                <div class="md:flex  ">
                    <div class="flex-1 m-auto">
                        <img src="https://i.ibb.co/jrW7rX6/beck.png" alt="" class=" w-72 mb-6 md:w-96  rounded-lg border-yellow-400 border-b-4 m-auto wow animate__animated animate__fadeInLeft" />
                    </div>
